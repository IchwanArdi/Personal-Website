...
export const TEXTS = {
  en: {
    ...
    // Footer texts
    footerTagline: 'Digital craftsman focused on creating meaningful experiences through thoughtful design and code.',
    openToOpportunities: 'Open to opportunities',
    connect: 'Connect',
    location: 'Purwokerto, Central Java',
    craftedWithIntention: 'Crafted with intention',
    poweredByCuriosity: 'Powered by curiosity',
  },
  id: {
    settings: 'Pengaturan',
    theme: 'Tema',
    ...
    language: 'Bahasa',
    settingsAutoSaved: 'Pengaturan tersimpan',
    navigation: 'Navigasi',
    connectWithMe: 'Hubungi saya',

    // Footer texts
    footerTagline: 'Pengrajin digital yang fokus menciptakan pengalaman bermakna melalui desain dan kode yang thoughtful.',
    openToOpportunities: 'Terbuka untuk peluang',
    connect: 'Hubungi',
    location: 'Purwokerto, Jawa Tengah',
    craftedWithIntention: 'Dibuat dengan maksud',
...
export const PROJECTS = {
  en: {
    ...
    noData: 'Projects will appear here once they are added to the database',
    noDataInfo: 'Projects are added periodically, so check back later!',
  ...
  id: {
    ...
    noData: 'Proyek akan muncul di sini setelah ditambahkan ke database',
    noDataInfo: 'Proyek ditambahkan secara berkala, jadi cek kembali nanti ya!',
...
export const DETAILPROJECT = {
  en: {
    ...
    noProjectInfo: 'The project you are looking for does not exist or has been removed.',
  ...
  id: {
    ...
    loadingProject: 'Memuat detail proyek...',
    noProject: 'Proyek tidak ditemukan',
    noProjectInfo: 'Proyek yang Anda cari tidak ada atau telah dihapus.',
